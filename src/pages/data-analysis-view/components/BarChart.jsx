...
const BarChart = ({ data }) => {
      ...
      return (
        <div className="bg-white p-3 border border-border rounded shadow-md">
          ...
          <div className="mt-2 pt-2 border-t border-border">
            <p className="text-xs text-text-tertiary">Click for detailed breakdown</p>
          </div>
        </div>
      );
    }
  ...
  const handleClick = (data, index) => {
    ...
    console.log(`Selected category: ${data.category} with ${data.count} incidents`);
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Legend 
            verticalAlign="top" 
            height={36}
            formatter={(value) => <span className="text-sm font-medium">Incident Count</span>}
          />
          <Bar 
            dataKey="count" 
            name="Incident Count"
